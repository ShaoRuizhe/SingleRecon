...
# from shapely.plotting import plot_polygon # not avai for shapely 1.7.1
...
def plot_polygons(axis, polygons, polygon_probs=None, draw_vertices=True, linewidths=2, markersize=10, alpha=0.2,
    ...
    edgecolors = np.array(colors, dtype=float)
    ...
    for i,polygon in enumerate(polygons):
        p ,_= plot_polygon(polygon, facecolor=facecolors[i], edgecolor=edgecolors[i], linewidth=linewidths)
        axis.add_patch(p)
