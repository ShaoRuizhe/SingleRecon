...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        # self.data_infos = self.load_annotations(self.ann_file)[:4]
        data_infos=self.load_annotations(self.ann_file)
        self.data_infos = [data_infos[i] for i in [59, 61, 64, 84, 99, 152, 199, 275]]
    ...
    def __getitem__(self, idx):
        ...
        while True:
            ...
            if data is None:
                ...
                continue
            return data
            # return {'img':data['img'],'gt_angle':data['gt_angle']}
    ...
    def prepare_test_img(self, idx):
        ...
        ann_info = self.get_ann_info(idx)# Ϊ�˲��ԽǶȵ�׼ȷ�ԣ�����ǩ�ĽǶ�Ҳ��ȡ����
        results = dict(img_info=img_info, ann_info=ann_info)
        if self.proposals is not None:
            results['proposals'] = self.proposals[idx]
        self.pre_pipeline(results)
