...
class MappingChallenge(LydornDataset):
    ...
    def process(self):
        ...
        # for i,image_info in tqdm(enumerate(image_info_list)):
        for i,image_info in enumerate(tqdm(image_info_list)):
            preprocess_one(image_info,pre_filter=self.pre_filter,pre_transform=self.pre_transform,processed_dir=self.processed_dir)
